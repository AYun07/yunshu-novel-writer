var ve=Object.defineProperty,Ie=Object.defineProperties;var be=Object.getOwnPropertyDescriptors;var $=Object.getOwnPropertySymbols;var ae=Object.prototype.hasOwnProperty,re=Object.prototype.propertyIsEnumerable;var ne=(i,e,t)=>e in i?ve(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t,E=(i,e)=>{for(var t in e||(e={}))ae.call(e,t)&&ne(i,t,e[t]);if($)for(var t of $(e))re.call(e,t)&&ne(i,t,e[t]);return i},N=(i,e)=>Ie(i,be(e));var q=(i,e)=>{var t={};for(var o in i)ae.call(i,o)&&e.indexOf(o)<0&&(t[o]=i[o]);if(i!=null&&$)for(var o of $(i))e.indexOf(o)<0&&re.call(i,o)&&(t[o]=i[o]);return t};import{w as Y}from"./components-30badcc3.js";const he={moyan:{id:"moyan",name:"莫言风格",category:"严肃文学",award:"诺贝尔文学奖 (2012)",avatar:"🏆",description:"魔幻现实主义，乡土与历史的交织，感官化的语言",systemPrompt:`你是莫言风格的文学创作大师。你的写作特点：
...
- 反转要有铺垫，不能为了反转而反转
- 人物要有秘密，每个人物都可能是嫌疑人
- 氛围描写要到位，让读者身临其境`,example:"",techniques:["精密布局","层层反转","氛围营造","红鲱鱼","人性深度"],bestFor:["悬疑小说","推理小说","犯罪小说"]}};function nt(){return Object.values(he)}function at(i){return he[i]||null}const ge={stream_of_consciousness:{id:"stream_of_consciousness",name:"意识流",category:"叙事技法",icon:"🌊",description:"模拟人物内心意识的自然流动，打破线性叙事",prompt:`请使用**意识流**技法进行创作。要求：
...
- **反转型**：出现了意想不到的变化
- **疑问型**：提出了引人深思的问题
- **预告型**：暗示即将发生重大事件`,example:"",bestFor:["网络小说","连载小说","悬疑推理","系列故事"]}};function rt(i){return ge[i]||null}function st(){const i={};return Object.values(ge).forEach(e=>{i[e.category]||(i[e.category]=[]),i[e.category].push(e)}),i}const Re={draft:{id:"draft",name:"初稿生成",step:1,icon:"📝",description:"根据设定生成初稿，注重故事完整性和基本质量",prompt:`你是一位专业的文学创作助手。请根据以下信息生成初稿：
...
### 最终修改版
请根据以上评审意见，输出最终修改版的完整内容。`,evaluationCriteria:["文学价值","艺术成就","情感力量","整体完成度"]}};function ct(i,e){const t=Re[i];if(!t)return"";let o=t.prompt;return Object.keys(e).forEach(a=>{o=o.replace(new RegExp(`\\{${a}\\}`,"g"),e[a])}),o}const ye={xuanhuan:{id:"xuanhuan",name:"玄幻小说",category:"网络小说",icon:"⚔️",description:"东方玄幻、西方奇幻、异世界等",systemPrompt:`你是顶级玄幻小说创作大神，精通玄幻小说的创作规律和读者心理。
...
- 潜台词要丰富
- 每个角色的说话方式要有辨识度
- 对话要推动情节或揭示人物`,bestFor:["电影","电视剧","网剧","短视频"]}};function dt(){return Object.values(ye)}function lt(i){return ye[i]||null}const ut=`你是一位专业的文学风格分析师。请对以下文本进行**纯风格层面**的深度分析。
...
待分析文本：
`,se=10*1024*1024;function mt(i,e=15e3){if(i.length<=e)return i;const t=Math.floor(e/3),o=i.slice(0,t),a=Math.floor(i.length/2)-Math.floor(t/2),r=i.slice(a,a+t),s=i.slice(-t);return`${o}
...
请严格检查并返回JSON：`},j="yunshu_style_profiles";function Q(){try{const i=localStorage.getItem(j);return i?JSON.parse(i):[]}catch(i){return[]}}function wt(i){const e=Q(),t=N(E({id:Date.now()},i),{savedAt:new Date().toISOString(),isFavorite:!1});return e.push(t),localStorage.setItem(j,JSON.stringify(e)),t}function _t(i){const t=Q().filter(o=>o.id!==i);localStorage.setItem(j,JSON.stringify(t))}function Et(){const i=Q(),e=new Blob([JSON.stringify(i,null,2)],{type:"application/json"}),t=URL.createObjectURL(e),o=document.createElement("a");o.href=t,o.download=`云书-风格档案-${new Date().toISOString().split("T")[0]}.json`,o.click(),URL.revokeObjectURL(t)}const St=`你是一位专业的小说结构分析师。请对以下文本进行**纯结构层面**的深度分析。
...
请输出摘要：`;function Rt(i){return{id:Date.now(),name:i.name||"未命名长篇",genre:i.genre||"玄幻",targetWordCount:i.targetWordCount||5e6,styleProfile:i.styleProfile||null,worldSetting:i.worldSetting||null,characters:i.characters||[],volumes:i.volumes||[],currentVolumeIndex:0,currentChapterIndex:0,chapterSummaries:{},powerStates:{},plotThreads:[],createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),stats:{totalChapters:0,totalWords:0,completedChapters:0}}}function Ot(i,e,t){return{index:i,name:e||`第${i}卷`,chapterCount:t||60,chapters:[],outline:"",coreConflict:"",powerLevelRange:"",status:"planned"}}function Tt(i,e,t,o){return{volumeIndex:i,chapterIndex:e,title:t||`第${e}章`,outline:o||"",content:"",summary:"",wordCount:0,status:"planned",createdAt:new Date().toISOString()}}const J="yunshu_novel_projects";function fe(){try{return JSON.parse(localStorage.getItem(J)||"[]")}catch(i){return[]}}function kt(i){const e=fe(),t=e.findIndex(o=>o.id===i.id);i.updatedAt=new Date().toISOString(),t>-1?e[t]=i:e.push(i),localStorage.setItem(J,JSON.stringify(e))}function Nt(i){const e=fe().filter(t=>t.id!==i);localStorage.setItem(J,JSON.stringify(e))}function At(i){const e=new Blob([JSON.stringify(i,null,2)],{type:"application/json"}),t=URL.createObjectURL(e),o=document.createElement("a");o.href=t,o.download=`云书-${i.name}-${new Date().toISOString().split("T")[0]}.json`,o.click(),URL.revokeObjectURL(t)}const we="yunshu_foreshadowings",A={PLANTED:"planted",DEVELOPING:"developing",RESOLVED:"resolved"},Oe={PLOT:"plot",CHARACTER:"character",SYMBOLIC:"symbolic",WORLDVIEW:"worldview",EMOTIONAL:"emotional",MYSTERY:"mystery",PROPHECY:"prophecy",CALLBACK:"callback"};function Pt({chapterTitle:i,chapterContent:e,novelGenre:t,existingForeshadowings:o=""}){return`你是一位经验丰富的小说编辑和文学分析师。请仔细阅读以下章节内容，从中识别出所有潜在的伏笔线索。
...
- 诗歌可以是碎片的拼贴
- 城市是重要的主题
- 用客观事物表达主观情感`,exampleWorks:["《荒原》","《四个四重奏》","《普鲁弗洛克的情歌》","《空心人》"],signatureQuote:"四月是最残忍的月份，从死去的土地里培育出丁香，把记忆和欲望混合在一起。",bestFor:["现代诗","长诗","现代主义诗歌","城市诗歌"],difficulty:"advanced"}},Ee={streamOfConsciousness:{id:"streamOfConsciousness",name:"意识流",icon:"🧠",category:"现代主义技法",description:"展现人物意识的流动，打破传统叙事逻辑",masters:["乔伊斯","伍尔夫","福克纳","普鲁斯特"],systemPrompt:`运用意识流技法：
...
`),l+=`
请根据以上要求创作一篇文学作品。`,l}function oi(i=10){return Ke.slice(0,i)}function ni(i=10){return ze.slice(0,i)}function ai(){return Xe}function ri(){return Ze}export{ni as $,It as A,bt as B,$t as C,Dt as D,Gt as E,Pt as F,Lt as G,xt as H,Ft as I,Wt as J,Mt as K,qt as L,Ht as M,Ut as N,jt as O,B as P,Ve as Q,Qt as R,Yt as S,Kt as T,zt as U,n as V,Jt as W,Zt as X,ei as Y,ti as Z,oi as _,rt as a,ai as a0,ri as a1,ii as a2,et as a3,tt as a4,Xt as a5,dt as a6,nt as a7,st as a8,Vt as a9,at as b,lt as c,Q as d,mt as e,wt as f,ct as g,_t as h,Et as i,yt as j,Bt as k,fe as l,gt as m,kt as n,ft as o,At as p,Rt as q,ht as r,ut as s,Ot as t,Nt as u,pt as v,St as w,Ct as x,vt as y,Tt as z};
