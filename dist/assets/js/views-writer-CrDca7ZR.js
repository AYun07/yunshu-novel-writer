...
2. 检查人物行为的合理性
3. 优化情节发展的连贯性
4. 确保时间线和因果关系清晰`})[a]||"进行全面优化",Jn=()=>{K.value=!1,xe.value=!1,Pe.value=!1,Ee.value=!1,O.value="",me.value="",$e.value=null,y.info("已停止AI生成")};Rt(O,()=>{K.value&&zt(()=>{const a=document.querySelector(".streaming-content");a&&(a.scrollTop=a.scrollHeight)})});const Yn=()=>{const a=localStorage.getItem("prompts");if(a)try{Ke.value=JSON.parse(a)}catch(e){console.error("加载提示词失败:",e),Ke.value=ln(),nn()}else Ke.value=ln(),nn()},ln=()=>[{id:1,title:"小说大纲生成器",category:"outline",description:"根据关键词和类型生成详细的小说大纲",content:`请为我创作一个{类型}小说的大纲，主题是{主题}，主角是{主角设定}。要求包含：
1. 故事背景设定
2. 主要人物介绍
3. 核心冲突
4. 章节大纲（至少10章）
...
`);C.value.前文概要=i}else Y.value&&J.value.length===0&&Tl();ot()}}},ml=(a,e)=>{const i=L.value[a],o=i.findIndex(d=>d.id===e.id);o>-1?i.splice(o,1):i.push(e)},la=a=>{ee.value=a,C.value={};const e=a.content.match(/\{([^}]+)\}/g);e&&e.forEach(i=>{const o=i.slice(1,-1);C.value[o]=""}),zt(()=>{rn()})},na=a=>({setting:"primary",magic:"danger",politics:"warning",geography:"success",history:"info"})[a]||"info",aa=a=>({setting:"世界设定",magic:"魔法体系",politics:"政治势力",geography:"地理环境",history:"历史背景"})[a]||a,sa=a=>({description:"success",dialogue:"primary",emotion:"warning",action:"danger",psychology:"info"})[a]||"info",oa=a=>({description:"场景描述",dialogue:"对话模板",emotion:"情感表达",action:"动作描写",psychology:"心理描写"})[a]||a,ia=a=>({high:"danger",normal:"primary",low:"info"})[a]||"primary",ra=be(()=>{if(!z.value||!Y.value)return[];const a=z.value.findIndex(e=>e.id===Y.value.id);return a<=0?[]:z.value.slice(0,a).filter(e=>e.content&&e.content.trim())}),Et=be(()=>z.value?z.value.filter(a=>a.description||a.content&&a.content.trim()).map(a=>({id:a.id,title:a.title,description:a.description,content:a.content,status:a.status,wordCount:a.wordCount||0,chapterIndex:fl(a)})):[]),fl=a=>z.value.findIndex(e=>e.id===a.id)+1,gl=(a,e=80)=>{if(!a)return"";let i=a.replace(/<[^>]*>/g,"");return i=i.replace(/&nbsp;/g," ").replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&#39;/g,"'"),i=i.replace(/\s+/g," ").trim(),i.length>e?i.substring(0,e):i},tl=()=>{if(J.value.length>0){const e=J.value.map(i=>z.value.find(o=>o.id===i)).filter(Boolean).map(i=>{let d=`第${fl(i)}章《${i.title}》
...
`);C.value.前文概要=e}else C.value.前文概要="";ot()},Tl=()=>{if(!Y.value||!z.value.length){J.value=[];return}const a=z.value.findIndex(i=>i.id===Y.value.id);if(a<=0){J.value=[];return}const e=z.value.slice(0,a).filter(i=>i.description||i.content&&i.content.trim()).slice(-2);J.value=e.map(i=>i.id),tl()},ua=()=>{J.value=[],tl(),y.success("已清空前文概要选择")},da=a=>{const e=J.value.indexOf(a);e>-1?J.value.splice(e,1):J.value.push(a),tl()},ca=()=>{J.value=Et.value.map(a=>a.id),tl(),y.success(`已选择所有${Et.value.length}个章节`)},va=()=>{Ue.value=!0,pe.value={count:5,includeMainCharacters:!0,includeSupportingCharacters:!0,includeMinorCharacters:!0,customPrompt:"",autoAssignRoles:!0},rl.value=[],Le.value=[]},un=()=>H(this,null,function*(){var a,e,i,o;if(Q()){yt.value=!0,rl.value=[],Le.value=[],O.value="",K.value=!0,me.value="batchCharacters";try{let d="";const p=[];pe.value.includeMainCharacters&&p.push("主角"),pe.value.includeSupportingCharacters&&p.push("配角"),pe.value.includeMinorCharacters&&p.push("次要角色"),At.value&&Nt.value?d=`=== 小说基本信息 ===
...
要求描述详细、生动，符合小说的类型、风格和整体世界观。`,p=yield qe.generateTextStream(d,{maxTokens:null,temperature:.8,type:"worldview"},(c,S)=>{O.value=S,De.value.description=S});De.value.description=p,y.success("AI世界观设定生成完成")}catch(o){console.error("AI生成世界观设定失败:",o),y.error(`设定生成失败: ${o.message}`)}finally{Qt.value=!1,K.value=!1,O.value=""}}}),wa=a=>H(this,null,function*(){var e,i;if(Q()){Pe.value=!0,K.value=!0,me.value="chapter",O.value="";try{console.log("使用自定义提示词生成章节:",a);const o=`=== 小说基本信息 ===
小说标题：${((e=x.value)==null?void 0:e.title)||"未命名小说"}
小说类型：${(()=>{var S;return{fantasy:"玄幻小说",urban:"都市言情",historical:"历史架空",martial:"武侠修仙",science:"科幻未来",romance:"现代言情",mystery:"悬疑推理",adventure:"冒险奇幻",horror:"恐怖惊悚",general:"通用小说"}[(S=x.value)==null?void 0:S.genre]||"通用小说"})()}
小说简介：${((i=x.value)==null?void 0:i.description)||"暂无简介"}
...
请确保生成的正文符合小说的整体风格、类型和世界观设定，与章节大纲保持一致。`,console.log("=== 发送给AI的完整提示词 ==="),console.log("选中的上下文章节:",c.map(f=>`第${z.value.findIndex(b=>b.id===f.id)+1}章：${f.title}`)),console.log(p),console.log("=== 提示词结束 ===");const S=yield qe.generateTextStream(p,{maxTokens:null,temperature:.8,type:"generation"},(f,b)=>{var V,ae;console.log("提示词生成流式回调:",f.length,"字符，总长度:",b.length),O.value=b;const T=Kt(b,E.value.title);((V=$e.value)==null?void 0:V.id)===((ae=E.value)==null?void 0:ae.id)&&(Z.value=T,Ae.value=!0)});if(!S.trim())throw new Error("AI返回内容为空");const D=Kt(S,E.value.title);Z.value=D,Ae.value=!0,E.value.status="draft",y.success("正文生成成功"),setTimeout(()=>{ft(),ze()},1e3)}catch(o){console.error("AI生成正文失败:",o),y.error(`正文生成失败: ${o.message}`)}finally{xe.value=!1,K.value=!1,O.value="",$e.value=null}}}),fn=(a=null)=>H(this,null,function*(){var e,i;if(Q()){if(!E.value||!Z.value){y.warning("请先选择章节并添加内容");return}Ee.value=!0,K.value=!0,me.value="optimize",O.value="",$e.value=E.value;try{let o=a;a||(oe.value?o=ke.value:o=gn());const d=`=== 小说基本信息 ===
小说标题：${((e=x.value)==null?void 0:e.title)||"未命名小说"}
小说类型：${(()=>{var S;return{fantasy:"玄幻小说",urban:"都市言情",historical:"历史架空",martial:"武侠修仙",science:"科幻未来",romance:"现代言情",mystery:"悬疑推理",adventure:"冒险奇幻",horror:"恐怖惊悚",general:"通用小说"}[(S=x.value)==null?void 0:S.genre]||"通用小说"})()}
小说简介：${((i=x.value)==null?void 0:i.description)||"暂无简介"}
...
使用提示词：${((a=oe.value)==null?void 0:a.title)||"默认提示词"}`,"优化预览",{confirmButtonText:"确定"})},Dl=()=>ll()>0&&(oe.value||Ge.value),Pa=()=>{const a=ll(),e=(a*.001).toFixed(3);return`文本${a}字，预估费用¥${e}`},Da=a=>H(this,null,function*(){var i,o;if(!Q())return;if(!E.value){y.warning("请先选择一个章节");return}if(!Z.value||Z.value.trim().length<50){y.warning("请先写一些内容，AI将基于现有内容进行续写");return}xe.value=!0,K.value=!0,me.value="continue",O.value="",$e.value=E.value;const e=Z.value;try{console.log("使用自定义提示词续写:",a);const d=wl(),p=Un.value;let c=`=== 小说基本信息 ===
小说标题：${((i=x.value)==null?void 0:i.title)||"未命名小说"}
小说类型：${(()=>{var b;return{fantasy:"玄幻小说",urban:"都市言情",historical:"历史架空",martial:"武侠修仙",science:"科幻未来",romance:"现代言情",mystery:"悬疑推理",adventure:"冒险奇幻",horror:"恐怖惊悚",general:"通用小说"}[(b=x.value)==null?void 0:b.genre]||"通用小说"})()}
小说简介：${((o=x.value)==null?void 0:o.description)||"暂无简介"}
...
请确保续写内容符合小说的整体风格、类型和世界观设定，与前文保持完美连贯性。`;const S=yield qe.generateTextStream(c,{maxTokens:null,temperature:.8,type:"continue"},(f,b)=>{var V,ae;const T=Kt(b,"");O.value=T,((V=$e.value)==null?void 0:V.id)===((ae=E.value)==null?void 0:ae.id)&&(Z.value=e+`
`+T,Ae.value=!0)});if(!S.trim())throw new Error("AI返回内容为空");const D=Kt(S,"");Z.value=e+`
`+D,Ae.value=!0,y.success("续写完成"),setTimeout(()=>{ft(),ze()},1e3)}catch(d){console.error("AI续写失败:",d),y.error(`续写失败: ${d.message}`),Z.value=e}finally{xe.value=!1,K.value=!1,O.value="",$e.value=null}}),Ma=a=>H(this,null,function*(){var e,i;if(Q()){if(!M.value.name.trim()){y.warning("请先输入角色姓名");return}K.value=!0,me.value="character",O.value="",M.value.appearance="",M.value.personality="",M.value.background="",M.value.tags=[];try{console.log("使用自定义提示词生成人物:",a);const p=`=== 小说基本信息 ===
小说标题：${((e=x.value)==null?void 0:e.title)||"未命名小说"}
...
请直接输出续写内容，无需额外说明：`,console.log("开始新的AI续写:",d.substring(0,200)+"...");const p=yield qe.generateTextStream(d,{maxTokens:null,temperature:.8,type:"continue"},(c,S)=>{Xe.value=S});if(!p.trim())throw new Error("AI返回内容为空");Xe.value=p.trim(),y.success("续写完成")}catch(i){console.error("AI续写失败:",i),y.error(`续写失败: ${i.message}`)}finally{bt.value=!1}}),ja=()=>{bt.value=!1,y.info("已停止续写")},qa=()=>H(this,null,function*(){if(!Xe.value){y.warning("没有可复制的内容");return}try{yield navigator.clipboard.writeText(Xe.value),y.success("续写内容已复制到剪贴板")}catch(a){console.error("复制失败:",a),y.error("复制失败，请手动复制")}}),Ga=()=>{if(!Xe.value){y.warning("没有可追加的内容");return}const a=Kt(Xe.value,"");Z.value=Z.value+`
...
请严格按照以下格式返回（只返回一个章节）：
大纲：[详细的章节内容描述，包含主要情节、人物发展、重要事件等]`;console.log("开始AI生成单章大纲:",o);const d=yield qe.generateTextStream(o,{maxTokens:null,temperature:.8,type:"outline"},(c,S)=>{O.value=S});if(!d.trim())throw new Error("AI返回内容为空");const p={id:Date.now(),title:fe.value.title,description:d.replace(/^大纲：/,"").trim(),content:"",wordCount:0,createdAt:new Date,updatedAt:new Date,status:"draft"};z.value.push(p),pt.value=!1,y.success("单章大纲生成成功"),ze()}catch(o){console.error("AI生成单章失败:",o),y.error(`单章生成失败: ${o.message}`)}finally{Pe.value=!1,K.value=!1,O.value=""}}}),js=()=>H(this,null,function*(){var a,e,i;if(Q()){if(console.log("开始批量生成章节"),console.log("当前章节列表:",z.value.map(o=>({title:o.title,description:o.description}))),F.value&&We.value){console.log("使用自定义提示词生成"),yield Ks(We.value);return}console.log("使用默认模板生成"),Pe.value=!0,K.value=!0,me.value="batch-chapters",O.value="";try{const o=Te.value.count,d=Te.value.plotRequirement,p=Te.value.template;console.log("批量生成章节配置检查:",{count:o,plotRequirement:d,template:p,formData:Te.value});const c=[];for(let b=1;b<=o;b++)c.push(`章节${b}：
标题：[章节标题]
...
优化后内容：`;console.log("开始AI优化内容:",e);const i=yield qe.generateTextStream(e,{maxTokens:null,temperature:.7,type:"optimize"},(o,d)=>{O.value=d,ce.value.optimizedContent=d});if(!i.trim())throw new Error("AI返回内容为空");ce.value.optimizedContent=i,y.success("内容优化完成")}catch(a){console.error("AI优化失败:",a),y.error(`优化失败: ${a.message}`)}finally{Ee.value=!1,K.value=!1,O.value=""}}}),Gs=()=>{E.value&&ce.value.optimizedContent?(E.value.content=ce.value.optimizedContent,Z.value=ce.value.optimizedContent,Ae.value=!0,kt.value=!1,y.success("优化内容已应用到当前章节")):y.warning("无法应用优化内容")},Ls=()=>{de.value="outline",he.value=!0},Hs=a=>H(this,null,function*(){var e,i,o;if(Q()){Pe.value=!0,K.value=!0,me.value="single-chapter",O.value="";try{const d=`=== 用户输入信息 ===
章节标题：${fe.value.title}
情节要求：${fe.value.plotRequirement||"请根据章节标题合理发展"}
模板类型：${Jt(fe.value.template)}
