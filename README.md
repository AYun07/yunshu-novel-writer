...
<p align="center">
  <strong>AI辅助小说创作平台 · 支持多种文学风格 · 长短篇小说项目管理</strong>
</p>
...
### 🏆 大师级文学创作
- **14种文学大师风格** - 莫言/余华/鲁迅/沈从文/王小波/贾平凹/马尔克斯/海明威/卡夫卡/托尔斯泰/村上春树等
- **10种文学技法** - 意识流/多视角/非线性叙事/不可靠叙述者/象征/五感写作等
- **3轮精修系统** - 初稿→深度润色→终审评审
- **文学质量评估** - 多维度评分参考

### 📚 长篇小说项目管理
- **智能上下文管理** - 自动摘要链、角色状态追踪
- **批量章节生成** - 整卷大纲生成、断点续传
- **质量控制** - 生成后自动检查
- **进度追踪** - 热力图、每日统计
...
### AI创作
- [x] 大师创作（14种风格、10种技法、3轮润色）
- [x] 风格仿写（24项参数、4种模式、原创度自检）
- [x] 长篇工坊（项目管理、批量生成、智能上下文）
- [x] 短文写作（快速创作、多类型模板）
- [x] 文学工坊（多风格创作、质量评估参考）
